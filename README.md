This is a simple console-based Mulitiplication game implemented in Java.
...
Ask user if they're ready to play. If they are not, show them the rules of the game again and ask them if they are now ready to play.
